    ...
    return (
      <form className="bindPhone">
        ...
        <div className="form-control">
          ...
          { this.state.telReg ? this.state.getCodes ? <div className="code">{this.state.time + 's'}</div> : <div className="code" onClick={this.getCode}><FormattedMessage id="app.account.bindPhone.get" /></div> : <div className="code" style={{ "color": "#ccc" }}><FormattedMessage id="app.account.bindPhone.get" /></div> }
        </div>
        <Toast
        ...
        <div className="form-control form-control-border">
          <Button onClick={this.handleSubmit}><FormattedMessage id="app.account.bindPhone.submit" /></Button>
          <Button onClick={this.jump} className="jump"><FormattedMessage id="app.account.bindPhone.jump" /></Button>
          <p className="remark"><FormattedMessage id="app.account.bindPhone.remark" /></p>
        </div>
      </form>
    );
  }
